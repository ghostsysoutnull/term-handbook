...
| [Doom Emacs](editors/EMACS_DOOM_GUIDE.md) | The popular Vim-first configuration framework. |
...
| [Package Managers](terminal/PACKAGE_MANAGERS_GUIDE.md) | `apt`, `brew`, `nix`, and the universal syntax. |
